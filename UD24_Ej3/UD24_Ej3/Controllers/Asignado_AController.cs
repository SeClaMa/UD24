...
namespace UD24_Ej3.Controllers
{
    ...
    public class Asignado_AController : ControllerBase
    {
        ...
        public async Task<ActionResult<Asignado_A>> PostAsignado_A(Asignado_A asignado_A)
        {
            ...
            {
                if (Asignado_AExists(asignado_A.Cientificos))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetAsignado_A", new { id = asignado_A.Cientificos }, asignado_A);
        }
        ...
        {
            return _context.Asignado_As.Any(e => e.Cientificos == id);
        }
    }
}
